...
※HTMLタグについて．各ダブルクォーテーションマークの中でHTMLタグを使用できる（使用するとしても，以下の例のようなルビぐらいだと思われるが）．HTMLタグを句の中に取り込んでいる場合など，きわめて特殊な事例の場合は，該当句の読み込みコードをinnerHTMLではなくtextContentにすることで対応可能である（同一の句内でHTMLタグとの併用は不可）．多くの場合は気にする必要はない．
*/

const kansaiA = [
    ["関西文芸高等学校Ａ"],
    ["", "<ruby>兼題<rt>けんだい</rt></ruby>1<ruby>先鋒<rt>せんぽう</rt></ruby>句", "", "兼題1中堅句", "", "兼題1大将句"],
